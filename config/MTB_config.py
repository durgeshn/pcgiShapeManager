...
facialConnectionsDict = {
    ...
    'face_r_cnr_fac_ctl_upLt': 'body_fac_lip_crnCorA_R',
    'face_r_cnr_fac_ctl_dnRt': '',
    'face_r_cnr_fac_ctl_upRt': '',
    'face_r_cnr_fac_ctl_dnLt': 'body_fac_lip_crnCorB_R',

    'face_l_cnr_fac_ctl_upLt': 'body_fac_lip_crnCorA_L',
    'face_l_cnr_fac_ctl_dnRt': '',
    'face_l_cnr_fac_ctl_upRt': '',
    'face_l_cnr_fac_ctl_dnLt': 'body_fac_lip_crnCorB_L'
}
